...
sat_74415 = sat_dict[74415]

plt.subplot(5, 2, 1)
plt.plot(sat_74415.MEAN_MOTION)
plt.title("mean motion")

plt.subplot(5,2,2)
plt.plot(sat_74415.ECCENTRICITY)
plt.title("eccentricity")

plt.subplot(5,2,3)
plt.plot(sat_74415.INCLINATION)
plt.title('inclicnation')

plt.subplot(5,2,4)
plt.plot(sat_74415.RA_OF_ASC_NODE)
plt.title('ra of asc node')

plt.subplot(5,2,5)
plt.plot(sat_74415.ARG_OF_PERICENTER)
plt.title('pericenter')

plt.subplot(5,2,6)
plt.plot(sat_74415.MEAN_ANOMALY)
plt.title('mean anomaly')

plt.subplot(5,2,7)
plt.plot(sat_74415.SEMIMAJOR_AXIS)
plt.title('semimajor axis')

plt.subplot(5,2,8)
plt.plot(sat_74415.PERIOD)
plt.title('period')

plt.subplot(5,2,9)
plt.plot(sat_74415.APOGEE)
plt.title('apogee')

plt.subplot(5,2,10)
plt.plot(sat_74415.PERIGEE)
plt.title('perigee')
...
>>>>>>> 4a5b1dc97e7347071cf21d755d2eb96a2c93692b
